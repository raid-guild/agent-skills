...
Wait for a human decision on whether the chosen render should be published internally.
...
A suspiciously short or degenerate-looking render should not be presented as a clean success.
...
- which media URL will actually be published internally
