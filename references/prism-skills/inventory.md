...
| rg-scribe-publisher-skill | RaidGuild public copy drafting | Source context, rg-content-strategy, rg-brand-voice | Voice, unsupported claims, public safety | rg-scribe-publisher-skill compatibility orchestrator | keep | Promoted as a concise workflow compatibility skill; delegates strategy, voice, and safety rules to their durable owners. |
