...
Produce `queen-raida-follow-candidates.md` with handles, profile URLs, rationale, risks, source refs, and already-followed status.

Do not follow accounts in this step.
